...
source_url: https://v5.chriskrycho.com/library/thinking-in-systems/boundary-drawing/
published: 2023-08-03T07:15:00.000-06:00
captured: 2026-02-15T12:01:11-05:00
tags: [boundaries]
---

# boundary-drawing and system design

*Notes from Thinking in Systems which I find particularly applicable to software.*

Quotes from, and notes on, bits from Donella Meadows, [*Thinking in Systems*](https://bookshop.org/a/21126/9781603580557) — specifically on the subject of system boundaries:
...
API and system design in software is in some sense the act of choosing to reify some boundaries and not to do so with others.
...
That does not imply that Meadows is wrong per se about the necessity of reconsidering boundaries. It does mean that the statement of that necessity is over-strong.
