...
UI exposes runtime control-plane state via same-origin proxy routes:

- `GET /api/runtime/stack-status`
- `GET /api/runtime/run-status`
- `GET /api/runtime/session-job-status`
- `GET /api/runtime/collector-pipeline-status`
- `GET /api/runtime/warnings`
