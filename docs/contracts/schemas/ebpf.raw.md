...
Downstream stages:
- Filtered (ownership-attributed) output: `docs/contracts/schemas/ebpf.filtered.v1.md`
  (`ebpf.filtered.v1`, `filtered_ebpf.jsonl`)
- Summary output for UI-friendly network rows: `docs/contracts/schemas/ebpf.summary.v1.md`
