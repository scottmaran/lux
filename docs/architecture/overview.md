...
This document is a short description of the current Lux architecture. It is
allowed to change as the implementation evolves. For externally visible
behavior, see `docs/contracts/`.

## Components
- `lux` (CLI): config + lifecycle wrapper for the local stack.
