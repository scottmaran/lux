...
- Input: `collector/ebpf_filtered_data.md` (`ebpf.filtered.v1`, `filtered_ebpf.jsonl`)
- Merge into timeline: `collector/timeline_filtered_data.md` (`timeline.filtered.v1`)
...
`schema_version` changed. See `collector/ebpf_filtered_data.md` for the full
field list.
