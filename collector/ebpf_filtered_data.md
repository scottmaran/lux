...
- Raw input schema: `collector/ebpf_raw_data.md` (`ebpf.v1`, `ebpf.jsonl`)
- Summary schema: `collector/ebpf_summary_data.md` (`ebpf.summary.v1`, `filtered_ebpf_summary.jsonl`)
